...
- `npm install`
- `node /scripts/pageDataGenerator.js`
- Select the number of fake data rows you'd like, or press enter to use the default 100 rows
- `npm start`

To generate a new data set at any point, re-run the `node /scripts/pageDataGenerator.js` command and refresh the page.


The remaining information in this readme was automatically generated by create-react-app, a React boilerplate/bootstrapping utility created by the React team.
